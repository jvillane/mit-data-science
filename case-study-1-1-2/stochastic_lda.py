...
def test(k, iterations):
    ...
    testset = SVILDA(vocab=vocab, K=k, D=847, alpha=0.2, eta=0.2, tau=1024, kappa=0.7, docs=allmydocs,
...
def main():
    ...
    if mode == "normal":
        ...
        lda = SVILDA(vocab=vocab, K=K, D=D, alpha=alpha, eta=eta, tau=tau, kappa=kappa, docs=docs,
                     iterations=iterations)
        lda.runSVI()
